...
import { getDoctorQueries, getRepliesByParentQueryId } from '../../requests'

export default function DoctorAddQuery(props) {
    ...
    let showDoctorQueries = async () => {
        let doctor_id = 2
        let data = await getDoctorQueries(doctor_id);
        changeQueries(data);
        console.log(data)
    }
